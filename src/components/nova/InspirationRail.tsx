...
import { EDITORIAL_ART, editorialTitle } from "@/lib/editorial-art";
...
export default function InspirationRail({
  ...
  const source = tab === "yours" ? mine : [...EDITORIAL_ART, ...room];
  ...
  return (
    ...
    >
      <div className="gallery-heading-area">
        <div className="gallery-intro">
          <div>
            <p className="section-kicker">
              {tab === "yours" ? "Your collection" : "The community canvas"}
            </p>
            <h2 id="gallery-title" className="gallery-heading">
              {tab === "yours" ? (
                <>All your happy accidents.</>
              ) : (
            ...
            <p className="gallery-subtitle">
              {tab === "yours"
                ...
                : "Something caught your eye? Borrow a prompt. Take it somewhere new."}
            </p>
          </div>
          <div
      ...
      >
        {tab === "yours" && ready && !user ? (
          <div className="gallery-empty">
            ...
            <Link href="/login?next=%2F%23yours">
      ...
      <footer className="gallery-footer">
        <span className="footer-wordmark">nova</span>
        <span>
          Nova studies are original AI editorial artworks. Starter images are
          examples. Community images are made here.
        </span>
        <Link href="/pricing">
          100 credits to begin. A world to explore. ↗
        </Link>
      </footer>
    </section>
  );
